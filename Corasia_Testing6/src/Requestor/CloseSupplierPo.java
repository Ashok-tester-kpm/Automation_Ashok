...
public class CloseSupplierPo extends BrowserClass
{
	  @Test(priority=4)
	  ...
	  public void suplrinfo() throws InterruptedException, IOException 
		{
		    ...
		    //Case1- Select a supplier form form 1
		 	driver.findElement(By.xpath("//a[contains(@href,'alei/737')]")).click();
	  ...
	  public void additionalinfo() throws Exception 
	  {
		  ...
		  //Purchase drop down value as FINANCE - 1.1.16
		  purchasedrpdwn.selectByVisibleText("FINANCE");
		  ...
		  driver.findElement(By.xpath("//button[contains(@aria-expanded,'false')]")).click();
