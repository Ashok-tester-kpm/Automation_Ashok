...
public class OpenPo extends BrowserClass
{
	  ...
	  public void additionalinfo() throws InterruptedException
	  {
		  ...
		  driver.findElement(By.xpath("//input[@id='50_Keene__Epicor']")).sendKeys("678910");
		  driver.findElement(By.xpath("//div//input[contains(@id,'50_MSD____BC__')]")).sendKeys("678910");
		  driver.findElement(By.xpath("//div//input[contains(@id,'50_OC__SAP__ECC')]")).sendKeys("678910");
		  driver.findElement(By.xpath("//div//input[contains(@id,'50_PeopleSoft__v9__x')]")).sendKeys("678910");
